...
export default function HousingAssignedEmail({
    ...
    const previewText = `Your Housing at Penkka University has been Issued`;
            ...
            <Tailwind>
                <Body className="bg-white my-auto mx-auto font-sans">
                    <Container className="my-[20px] mx-auto px-[15px] py-[20px] w-[465px]">
                        ...
                        <Text className="text-black text-[14px] leading-[24px]">
                            We are pleased to inform you that your housing application has been processed and a room has been officially assigned to you at Penkka University.
                        </Text>
                        ...
                        <Section className="text-center mt-[32px] mb-[32px]">
                            <Link
                                ...
                                href="https://penkka.fi/portal/student/housing"
                            >
