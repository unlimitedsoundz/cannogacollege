...
export default function NewsletterEmail({
    ...
    const previewText = `Important updates regarding your journey to Penkka University.`;
                ...
                <Body className="bg-[#f8f9fa] my-auto mx-auto font-sans text-[#1a1a1a]">
                    <Container className="bg-white my-[40px] mx-auto overflow-hidden w-[600px]">
                        ...
                        <Section className="px-[40px] pt-[40px] pb-[20px]">
                            ...
                            <Text className="text-[16px] leading-[1.6] color-[#444444]">
                                We are pleased to welcome you to the Penkka University community. This newsletter provides you with critical updates, upcoming deadlines, and the necessary next steps for your official admission process.
                            </Text>
                        </Section>
                        ...
                        <Section className="p-[40px] text-center">
                            ...
                            <Text className="text-[12px] text-[#888888] my-[10px]">
                                Admissions Office: admissions@penkka.fi
                            </Text>
                            <Hr className="border-t border-solid border-[#eeeeee] my-[20px]" />
                            <Section className="text-center">
                                <Link href="https://penkka.fi" className="text-[#333333] no-underline mx-[10px] text-[12px]">Website</Link>
                                <span className="text-[#dddddd]">|</span>
                                <a href="https://penkka.fi/privacy" className="text-[#333333] no-underline mx-[10px] text-[12px]">Privacy Policy</a>
                            </Section>
                            <Text className="text-[12px] text-[#888888] mt-[20px] mb-0">
                                &copy; 2026 Penkka University. All rights reserved.
                            </Text>
                        </Section>
