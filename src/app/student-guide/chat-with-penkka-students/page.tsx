...
export const metadata = {
    title: 'Chat with Students | Penkka University',
    description: 'Connect with current Penkka University students and ambassadors to learn more about student life in Finland.',
    alternates: {
        canonical: 'https://penkka.fi/student-guide/chat-with-penkka-students/',
    },
};
        ...
        <GuideSidebarLayout sections={sections}>
            <div className="min-h-screen bg-white text-black font-sans pb-20">
                ...
                <Hero
                    ...
                    body="Get a first-hand perspective on what it's like to study at Penkka University. Our student ambassadors are here to answer your questions about academics, campus life, and living in Finland."
                    ...
                    image={{
                        ...
                        alt: "Penkka University Students"
                    }}
                />
                    ...
                    <div className="space-y-20">
                        ...
                        <section id="chat-platform" className="scroll-mt-32">
                            <div className="bg-neutral-100 p-1 rounded-2xl border border-neutral-200 shadow-xl overflow-hidden">
                                <div className="bg-card" style={{ height: '800px' }}>
                                    <iframe 
                                        src="https://students.penkka.fi/" 
                                        width="100%"
                                        height="100%"
                                        className="w-full h-full border-none"
                                        title="Chat with Penkka Students"
                                ...
                                <div className="p-4 flex justify-between items-center text-[10px] font-bold uppercase tracking-widest text-black">
                                    ...
                                    <Link href="https://students.penkka.fi/" target="_blank" className="underline hover:text-black">Open in New Tab</Link>
                                </div>
                            </div>
                        </section>
                                ...
                                body={
                                    <div className="space-y-8 text-left">
                                        <p className="text-sm font-bold text-black leading-relaxed">
                                            Our ambassadors represent different schools and programs. They are passionate about Penkka and eager to share their experiences.
                                        </p>
                                        <Link 
                                            href="https://ourblogs.penkka.fi/" 
                        ...
                        <section className="scroll-mt-32">
                            <CTA
                                ...
                                body="Join our community platform and connect with the people who make Penkka University what it is."
                                cta={{
