...
export default function AdminLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            localStorage.setItem('Penkka_user', JSON.stringify({
                id: authData.user.id,
                email: profile.email,
                role: profile.role,
        ...
        <div className="max-w-md mx-auto mt-12 bg-white p-8 rounded-2xl shadow-sm border border-neutral-100 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-6 mt-2">
                ...
                <div>
                    ...
                    <p className="text-neutral-500 text-xs font-medium uppercase tracking-wider">Penkka University SIS</p>
                </div>
            </div>
