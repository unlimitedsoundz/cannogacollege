...
export const metadata: Metadata = {
    title: 'Academic Regulations — Penkka University',
    description: 'The Academic Regulations establish the framework governing teaching, learning, assessment, and academic progression at Penkka University.',
    alternates: {
        canonical: 'https://penkka.fi/academic-regulations/',
    },
};
            ...
            <section className="bg-black text-white pt-40 pb-16">
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <p className="text-neutral-400 text-lg max-w-2xl">
                        The framework governing teaching, learning, assessment, and academic progression at Penkka University.
                    </p>
                </div>
            </section>
                    ...
                    <div className="space-y-16">
                        ...
                        <div>
                            ...
                            <p className="text-black leading-relaxed pl-14">
                                The Academic Regulations establish the framework governing teaching, learning, assessment, and academic progression at Penkka University.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="pl-14 space-y-2">
                                <li className="flex items-start gap-3 text-black">
                                    <span className="w-1.5 h-1.5 bg-black rounded-full mt-2 shrink-0"></span>
                                    Penkka University maintains permanent academic records
                                </li>
                                <li className="flex items-start gap-3 text-black">
                                    <span className="w-1.5 h-1.5 bg-black rounded-full mt-2 shrink-0"></span>
                        ...
                        <div>
                            ...
                            <p className="text-black leading-relaxed pl-14">
                                Penkka University reserves the right to amend academic regulations. Changes will be communicated to students in advance where possible.
                            </p>
                        </div>
