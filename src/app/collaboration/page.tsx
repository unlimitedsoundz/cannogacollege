...
export const metadata = {
    title: 'Collaboration & Partnerships | Penkka University',
    description: 'Partner with Penkka University for research, innovation, and education. Join our network of industry leaders driving systemic change.',
    alternates: {
        canonical: 'https://penkka.fi/collaboration/',
    },
};
    ...
    return (
        <div className="min-h-screen bg-white text-black font-sans">
            ...
            <SchemaLD data={{
                ...
                "@type": "WebPage",
                "name": "Collaboration & Partnerships at Penkka University",
                "url": "https://penkka.fi/collaboration",
                "description": "Information on industry partnerships, collaborative research, and corporate training at Penkka University."
            }} />
                ...
                <div className="container mx-auto flex flex-col lg:flex-row items-center gap-2 lg:gap-16 pt-0 md:pt-12 pb-12 lg:pb-0 h-auto lg:h-[600px] lg:py-0 relative mb-0">
                    ...
                    <div className="lg:w-1/2 space-y-6 relative z-10 flex flex-col justify-center h-full pt-2 lg:pt-0 px-4 md:px-0 text-left">
                        <h1 className="font-bold leading-[1.1] tracking-tight pt-2 text-black uppercase" style={{ fontSize: '40px' }}>
                            Partner with Penkka University
                        </h1>
                ...
                <section className="mb-32">
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        ...
                        <p className="text-lg text-neutral-600 leading-relaxed">
                            Penkka University offers a dynamic ecosystem where organizations can access top-tier talent, engage agile R&D capabilities, and upskill their workforce.
                        </p>
                    </div>
                ...
                <section className="mb-32">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            <h2 className="text-3xl md:text-4xl font-bold leading-tight">Ways to Engage with the Penkka Community</h2>
                            <ul className="space-y-6">
                                {[
                                    ...
                                    { title: "Startup Incubation", desc: "Connect with the Penkka Entrepreneurship Hub to mentor or invest in early-stage student ventures." }
                                ].map((item, i) => (
                        ...
                        <div className="relative h-[600px] w-full overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-10">
                                <p className="text-white text-xl font-medium leading-relaxed">
                                    "Our partnership with Penkka allows us to tap into fresh perspectives while tackling complex engineering challenges."<br />
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 relative z-10">
                            <div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <a href="mailto:partnerships@penkka.fi" className="text-white text-lg hover:opacity-70 transition-colors underline">partnerships@penkka.fi</a>
                                </div>
                            </div>
