...
export const metadata = {
    title: 'About Cannoga College — Our Story, Mission & Ottawa Campus',
    description: "Cannoga College is a dynamic and career-focused institution located in Ottawa, Canada's capital city, committed to providing high-quality education through a wide range of Diploma, Degree, and Certificate programs.",
    alternates: {
        canonical: 'https://cannogacollege.ca/about-cannoga-college/',
    },
};
    ...
    return (
        <div className="min-h-screen bg-white text-black font-sans">
            <BreadcrumbSchema items={[
                { name: 'Home', item: '/' },
                { name: 'About Cannoga College', item: '/about-cannoga-college' }
            ]} />
            ...
            <SchemaLD data={{
                ...
                "url": "https://cannogacollege.ca/about-cannoga-college",
                "mainEntity": {
            ...
            <Hero
                ...
                body="Cannoga College is a dynamic and career-focused institution located in Ottawa, Canada's capital city, committed to providing high-quality education through a wide range of Diploma, Degree, and Certificate programs."
            ...
            <div className="cc-container py-8 md:py-20">
                ...
                <section className="max-w-4xl mx-auto mb-16 space-y-5 text-lg leading-relaxed">
                    <p className="font-semibold text-xl text-[#2e1150]">
                        Cannoga College is a forward-looking, career-oriented institution located in Ottawa, the capital city of Canada. The college is dedicated to delivering quality post-secondary education through a range of Certificate, Diploma, and Degree programs designed to equip students with the skills needed in today's global and evolving job market.
                    </p>
                    ...
                    <p className="text-neutral-600">
                        International students are supported through dedicated services including admissions guidance, study permit assistance, academic advising, career development support, and newcomer integration services to ensure a smooth transition to life and studies in Canada.
                    </p>
                    <p className="font-semibold text-[#5c2d91]">
                        ...
                        <ul className="grid md:grid-cols-2 gap-6 mb-12">
                            {[
                                ...
                                <li key={i} className="cc-card flex items-start gap-4 p-5">
                                    <ArrowRight size={18} weight="bold" className="shrink-0 text-[#5c2d91] mt-0.5" />
                                    <span className="text-neutral-700 font-medium leading-snug">{item}</span>
                                </li>
                            ))}
                        </ul>
                        <p className="text-neutral-600 text-lg leading-relaxed bg-[#f7f4fc] p-8 border-l-4 border-[#5c2d91]">
                            Our Ottawa campus provides a supportive and inclusive environment where students and faculty work together to explore real-world challenges and develop innovative, future-ready solutions.
                        </p>
                    </div>
                </section>
            ...
            {/* Key Figures */}
            <div className="py-20 bg-[#2e1150] text-white w-full">
