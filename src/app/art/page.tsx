...
export const metadata = {
    title: 'Art & Exhibitions — Penkka University | Gallery & Creative Showcase',
    description: 'Explore art exhibitions, creative showcases, and gallery events at Penkka University Helsinki. Featuring works by students and faculty in fine arts, design, and media.',
};
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            <div className="container mx-auto px-4 py-24">
                <h1 className="text-6xl font-light mb-4 pt-8">Penkka<span className="font-bold">ART</span></h1>
