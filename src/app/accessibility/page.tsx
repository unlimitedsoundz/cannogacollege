                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl space-y-4">
                        ...
                        <p className="text-lg text-neutral-600 leading-relaxed">
                            Penkka University is committed to ensuring digital accessibility for all users, regardless of ability or technology used.
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="prose prose-neutral max-w-none space-y-16">
                            ...
                            <section id="commitment" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    Penkka University is committed to ensuring digital accessibility for all users including students applicants staff partners and members of the public. We strive to provide an inclusive online environment that allows everyone to access information services and digital content equally regardless of ability or technology used.
                                </p>
                                <p className="text-neutral-700 leading-relaxed">
                                    This Accessibility Statement describes how Penkka University complies with applicable accessibility legislation and standards and how users can report accessibility issues.
                                </p>
                            </section>
                            ...
                            <section id="scope" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    This Accessibility Statement applies to the official Penkka University website and related digital services including online application platforms learning management systems and publicly available digital content provided by Penkka University.
                                </p>
                            </section>
                            ...
                            <section id="standards" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed mb-6">
                                    Penkka University aims to comply with the following standards and legal requirements:
                                </p>
                            ...
                            <section id="status" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    Penkka University digital services are partially compliant with WCAG 2.1 level AA. Continuous efforts are being made to improve accessibility and to address any identified shortcomings.
                                </p>
                            </section>
                            ...
                            <section id="features" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed mb-6">
                                    The following accessibility features are implemented across Penkka University digital platforms where possible:
                                </p>
                            ...
                            <section id="non-accessible" className="scroll-mt-32 space-y-4">
                                ...
                                <ul className="space-y-2 text-neutral-700 list-none p-0 text-sm">
                                    ...
                                    <li>• Third party content or systems not fully controlled by Penkka University</li>
                                ...
                                <p className="text-neutral-700 leading-relaxed mt-4">
                                    Penkka University is actively working to address these issues and prioritises accessibility improvements based on user impact.
                                </p>
                            </section>
                            ...
                            <section id="alternative" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    If a user is unable to access specific content or services due to accessibility limitations Penkka University will provide information in an alternative accessible format upon request whenever reasonably possible.
                                </p>
                            </section>
                            ...
                            <section id="feedback" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    Penkka University welcomes feedback on the accessibility of its digital services. Users who experience accessibility barriers or require assistance are encouraged to contact the institution.
                                </p>
                                <p className="text-neutral-700 leading-relaxed">
                                    Accessibility related feedback can be submitted through the official Penkka University contact channels listed on the website. Requests will be handled promptly and in accordance with applicable regulations.
                                </p>
                            </section>
                            ...
                            <section id="enforcement" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    If a user is not satisfied with the response received from Penkka University they may contact the supervisory authority responsible for monitoring digital accessibility in Finland.
                                </p>
                                <p className="text-neutral-700 leading-relaxed">
                            ...
                            <section id="improvement" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed mb-4">
                                    Penkka University regularly reviews and updates its digital services to improve accessibility. This includes:
                                </p>
                                <ul className="space-y-2 text-neutral-700 list-none p-0 text-sm">
                            ...
                            <section id="preparation" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    This Accessibility Statement was prepared based on internal assessments and reviews of Penkka University digital services.
                                </p>
                                <p className="text-neutral-700 leading-relaxed">
                            ...
                            <section id="date" className="scroll-mt-32 space-y-4 pt-8">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    This Accessibility Statement is effective upon publication and reflects the current accessibility status of Penkka University digital services.
                                </p>
                            </section>
