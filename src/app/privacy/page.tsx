...
export const metadata = {
    title: 'Privacy Policy | Penkka University',
    description: 'Learn how Penkka University protects your personal data and respects your privacy in accordance with GDPR and Finnish laws.',
    alternates: {
        canonical: 'https://penkka.fi/privacy/',
    },
};
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl space-y-4">
                        ...
                        <p className="text-lg text-neutral-600 leading-relaxed">
                            How Penkka University handles personal data in accordance with the GDPR and Finnish data protection legislation.
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="prose prose-neutral max-w-none space-y-8 md:space-y-16">
                            ...
                            <section id="introduction" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    Penkka University is committed to protecting the privacy and personal data of its students, applicants, staff, partners, alumni, and website users. This Privacy Policy explains how Penkka University collects, uses, stores, shares, and protects personal data in accordance with applicable data protection laws, including the General Data Protection Regulation (GDPR) and relevant Finnish data protection legislation.
                                </p>
                                <p className="text-neutral-700 leading-relaxed">
                                    By engaging with Penkka University, including applying for admission, enrolling in programmes, using our services, or visiting our digital platforms, you acknowledge that your personal data may be processed as described in this policy.
                                </p>
                            </section>
                            ...
                            <section id="data-controller" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    Penkka University acts as the data controller for personal data processed in relation to its educational, administrative, and operational activities.
                                    Contact details of the Data Protection Officer or responsible unit will be made available on the official Penkka University website.
                                </p>
                            </section>
                            ...
                            <section id="scope" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    This Privacy Policy applies to all personal data processed by Penkka University, including data related to prospective students, enrolled students, graduates, staff, visiting lecturers, partners, research participants, and users of Penkka University websites, systems, and services.
                                </p>
                            </section>
                            ...
                            <section id="categories" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed mb-6">
                                    Penkka University may collect and process the following categories of personal data where relevant and lawful:
                                </p>
                                ...
                                <p className="text-sm text-neutral-500 italic mt-6">
                                    Penkka University does not intentionally collect sensitive personal data unless required by law or necessary to fulfil statutory obligations.
                                </p>
                            </section>
                            ...
                            <section id="purposes" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed mb-6">
                                    Penkka University processes personal data for the following purposes:
                                </p>
                            ...
                            <section id="sharing" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    Penkka University may share personal data with third parties only where necessary and lawful, including government authorities, educational partners, service providers, and research partners. All third parties are required to process data in accordance with law and confidentiality obligations.
                                </p>
                            </section>
                            ...
                            <section id="transfers" className="scroll-mt-32 space-y-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    Where personal data is transferred outside the EEA, Penkka University ensures appropriate safeguards are in place, such as adequacy decisions or standard contractual clauses.
                                </p>
                            </section>
                            ...
                            <section id="contact" className="scroll-mt-32 space-y-4 pt-8 underline-offset-4">
                                ...
                                <p className="text-neutral-700 leading-relaxed">
                                    For questions or requests, please contact Penkka University through the official channels listed on our website.
                                </p>
                                <div className="pt-4">
                                    <p className="text-sm font-bold text-black">Data Protection Officer</p>
                                    <p className="text-sm text-neutral-500">privacy@penkka.fi</p>
                                </div>
                            </section>
