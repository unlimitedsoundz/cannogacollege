...
export const metadata = {
    title: 'Refund & Withdrawal Policy | Cannoga College',
    description: 'Guidelines on financial obligations, withdrawals, and refunds for tuition, fees, and housing at Cannoga College.',
    alternates: {
                        ...
                        <div className="flex flex-col md:flex-row gap-6 md:gap-12 border-t border-black pt-8">
                            ...
                            <div className="md:w-3/4">
                                ...
                                <p className="text-lg leading-relaxed mt-6">
                                    This policy applies to all students enrolled at Cannoga College, including Bachelor’s, Master’s, full-time, and part-time students.
                                </p>
                            </div>
                        </div>
                    </section>
