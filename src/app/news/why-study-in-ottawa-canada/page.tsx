...
export const metadata = {
    title: 'Why Study in Ottawa Canada? 10 Reasons International Students Choose Ottawa | Cannoga College',
    description: 'Discover why Ottawa Canada is one of North America\'s top study destinations. From world-class education to a thriving tech ecosystem, here are 10 reasons students choose Ottawa.',
        ...
        <div className="min-h-screen bg-white font-sans text-black">
            ...
            <Hero
                ...
                image={{
                    ...
                    alt: "Aerial view of Ottawa, Canada with university campus and parks"
                }}
                breadcrumbs={[
                    { label: 'Home', href: '/' },
            ...
            <div className="container mx-auto px-4 pb-16 md:pb-24 max-w-4xl">
                    ...
                    {reasons.map((reason, index) => {
                        ...
                        return (
                            <div key={index} className="flex gap-8 items-start">
                                {/* Number */}
                                <div className="flex-shrink-0 w-16 h-16 bg-[#5c2d91] text-white flex items-center justify-center font-bold text-2xl">
                                    {index + 1}
                                </div>
                                {/* Content */}
                                <div className="flex-1">
                                    <h2 className="text-aalto-5 font-bold mb-4 text-[#2e1150] tracking-tight flex items-center gap-4">
                ...
                <div className="mt-20 grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        <Link key={link.href} href={link.href} className="bg-neutral-50 p-8 hover:bg-neutral-100 transition-all group border-l-2 border-transparent hover:border-[#5c2d91]">
                            <h3 className="font-bold text-[#2e1150] mb-2 group-hover:underline">{link.title}</h3>
