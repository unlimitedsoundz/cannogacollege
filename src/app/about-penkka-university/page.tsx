...
export const metadata = {
    title: 'About Penkka University — Our Story, Mission & Helsinki Campus',
    description: 'Penkka University is an independent higher education institution in Helsinki, Finland, offering English-taught Bachelor’s and Master’s degree programmes focused on engineering, technology, business, science, and the arts.',
    alternates: {
        canonical: 'https://penkka.fi/about-penkka-university/',
    },
};
    ...
    return (
        <div className="min-h-screen bg-white text-black font-sans">
            <BreadcrumbSchema items={[
                { name: 'Home', item: '/' },
                { name: 'About Penkka University', item: '/about-penkka-university' }
            ]} />

            <SchemaLD data={{
                "@context": "https://schema.org",
                "@type": "AboutPage",
                "name": "About Penkka University",
                "url": "https://penkka.fi/about-penkka-university",
                "mainEntity": {
                    "@type": "EducationalOrganization",
                    "name": "Penkka University Helsinki",
                    "description": "Penkka University is an independent higher education institution in Helsinki, Finland, offering English-taught Bachelor's and Master's degree programmes.",
                    "url": "https://penkka.fi"
                }
            }} />
            ...
            {/* HERO SECTION */}
            <Hero
                title="About Penkka University"
                body="Learn about Penkka University, an independent higher education institution based in Helsinki, Finland, focused on sustainability, innovation, and practical learning. Penkka University brings together academic knowledge and real-world application to prepare students for global careers."
                ...
                image={{
                    ...
                    alt: "Penkka University – Helsinki Campus main building"
                }}
            />
                        ...
                        <ContentBox
                            ...
                            body={
                                <div className="space-y-4">
                                    <p>Penkka University is inspired by the Nordic tradition of Sivistys — a holistic approach to education that combines personal development, critical thinking, and social responsibility.</p>
            ...
            <div className="container mx-auto px-4 py-8 md:py-24">
                    ...
                    <ContentBox
                        ...
                        body={
                            <div className="space-y-4">
                                ...
                                <p>
                                    From music festivals to tech hackathons, your time at Penkka is about more than just studies. Our campus in Helsinki is a hub of activity where students from over 60 countries collaborate and create.
                                </p>
                            </div>
                        }
                        image={{
                ...
                <section className="mb-32">
                    <div className="flex justify-between items-end mb-aalto-p6">
                        <h2 className="text-aalto-5 font-bold tracking-tight">Latest from Penkka</h2>
