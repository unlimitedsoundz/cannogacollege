...
export const metadata: Metadata = {
    title: 'Student Handbook 2026–2027 — Penkka University',
    description: 'The official Penkka University Student Handbook covering academic policies, student responsibilities, services, and institutional regulations for the 2026–2027 academic year.',
    alternates: {
        canonical: 'https://penkka.fi/student-handbook/',
    },
};
                ...
                <div className="container mx-auto px-4 max-w-4xl space-y-16">
                    ...
                    <div>
                        ...
                        <div className="pl-14 space-y-4 text-black leading-relaxed">
                            <p>Welcome to Penkka University.</p>
                            <p>This Student Handbook is the official guide to academic life, institutional policies, student responsibilities, and available services at Penkka University. All students are required to read, understand, and comply with the regulations outlined in this handbook.</p>
                            <p>This handbook forms part of the regulatory framework of Penkka University and applies to all enrolled Bachelor&apos;s and Master&apos;s students.</p>
                        </div>
                    </div>

                    {/* 2 */}
                    <div>
                        <div className="flex items-baseline gap-4 mb-4"><Num n={2} /><h2 className="text-2xl font-bold">About Penkka University</h2></div>
                        <div className="pl-14 space-y-4">
                            <p className="text-black leading-relaxed">Penkka University is a higher education institution offering internationally oriented Bachelor&apos;s and Master&apos;s programmes. The University is committed to:</p>
                            ...
                            <p className="text-black">Penkka University operates in accordance with recognized academic standards and institutional best practices.</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="pl-14 space-y-8">
                            <div>
                                ...
                                <p className="text-black mb-3">Penkka University offers Bachelor&apos;s and Master&apos;s degrees. Each programme defines:</p>
                                <ul className="space-y-2">
                    ...
                    <div>
                        ...
                        <div className="pl-14">
                            <p className="text-black mb-3">Where applicable, Penkka University may offer:</p>
                            <ul className="space-y-2">
