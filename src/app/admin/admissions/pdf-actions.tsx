...
export async function generateAndStoreOfferLetter(applicationId: string) {
    ...
    try {
        const offerLetterUrl = `https://penkka.fi/portal/application/letter?id=${applicationId}`;
...
export async function generateAndStoreAdmissionLetter(applicationId: string) {
    ...
    try {
        ...
        const admissionLetterUrl = `https://penkka.fi/portal/application/admission-letter?id=${applicationId}`;
...
export async function generateAndStoreReceipt(applicationId: string) {
    const supabase = createClient();
    try {
        const receiptUrl = `https://penkka.fi/portal/application/receipt?id=${applicationId}`;
