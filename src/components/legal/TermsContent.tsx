                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl space-y-4">
                        ...
                        <p className="text-lg text-neutral-600 leading-relaxed">
                            The terms governing the use of Penkka University digital platforms and services.
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="prose prose-neutral max-w-none space-y-8 md:space-y-24">
                            ...
                            <section id="acceptance" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    <p>
                                        By accessing or using Penkka University websites digital platforms and services users agree to comply with these Terms of Use and Conditions. If a user does not agree with these terms they should refrain from using the services.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section id="scope" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    <p>
                                        These Terms apply to all users of Penkka University digital services including prospective students enrolled students staff partners and visitors.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section id="use-of-services" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    <p>
                                        Users agree to use Penkka University services lawfully respectfully and in a manner that does not disrupt or harm systems content or other users.
                                    </p>
                                    <p>
                            ...
                            <section id="intellectual-property" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    <p>
                                        All content on Penkka University websites including text images graphics logos documents and digital materials is the intellectual property of Penkka University or its licensors unless otherwise stated.
                                    </p>
                                    <p>
                            ...
                            <section id="user-generated-content" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    ...
                                    <p>
                                        Penkka University reserves the right to remove or restrict content that violates these Terms or applicable laws.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section id="availability" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    <p>
                                        Penkka University aims to ensure continuous availability of its digital services but does not guarantee uninterrupted access. Services may be temporarily unavailable due to maintenance technical issues or external factors.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section id="limitation-of-liability" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    <p>
                                        Penkka University is not liable for direct or indirect damages arising from the use or inability to use its digital services except where liability cannot be excluded under applicable law.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section id="data-protection" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    <p>
                                        The processing of personal data is governed by the Penkka University Privacy Policy. Users are encouraged to review the Privacy Policy to understand how personal data is handled.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section id="external-links" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    <p>
                                        Penkka University websites may contain links to external websites. Penkka University is not responsible for the content or data protection practices of external sites.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section id="changes" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    <p>
                                        Penkka University may update these Terms of Use and Conditions at any time. Updated terms will be published on the official website and apply from the date of publication.
                                    </p>
                                </div>
                            </section>
                            ...
                            <section id="contact" className="scroll-mt-32">
                                ...
                                <div className="space-y-6 text-neutral-700 leading-relaxed">
                                    <p>
                                        For questions regarding these Terms of Use and Conditions please contact Penkka University through the official communication channels listed on the website.
                                    </p>
                                </div>
                            </section>
