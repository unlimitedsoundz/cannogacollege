...
const Penkka_CONTEXT = `
Penkka University is a higher education institution in Helsinki, Finland, dedicated to sustainability, innovation, and practical excellence.
...
- Tuition Fees: Penkka University accepts tuition payments exclusively via direct bank transfer to Kuda Bank.
- Kuda Bank Details: Bank: Kuda Bank, Account Number: 3003469520, Account Name: Penkka EDUCATIONAL SERVICES.
...
Contact: admissions@penkka.fi | +358-20-4721-739
`;
    ...
    try {
        ...
        if (!openaiApiKey) {
            ...
            return new Response(JSON.stringify({
                reply: "I'm currently in 'offline' mode because my AI brains are being configured. However, I can still tell you that Penkka University is a leader in sustainability! Please ask your administrator to configure the OPENAI_API_KEY secret."
            }), {
        ...
        const messages = [
            { role: "system", content: `You are a helpful assistant for Penkka University. Use the following context to answer student questions. If you don't know the answer, politely refer them to admissions@penkka.fi.\n\nContext:\n${Penkka_CONTEXT}` },
